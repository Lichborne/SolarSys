...
(project_root) -[:LOG_HISTORY]-> (a :LOG_NODE {guid: '2f6e4433-6aeb-4072-8949-1b2da6e9eb59', change: 'INSERT', description: 'description', timestamp : '123'}),
(a) -[:LOG_LINK]-> (b :LOG_NODE {guid: 'fd22adc2-45eb-48f7-a4e7-e1836af257cf', change: 'INSERT', description: 'description', timestamp : '123'});
